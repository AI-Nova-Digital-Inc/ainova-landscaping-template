      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <div className="relative mb-5 h-16 w-44">
            <Image src="/images/logo/everstone-logo.svg" alt="Everstone Outdoor Living" fill className="object-contain object-left" style={{ filter: "brightness(0) invert(1)" }} />
          </div>
          ...
          <ul className="mt-6 grid gap-2.5 text-sm text-warm-white/70">
            <li className="flex items-center gap-2"><Phone size={14} className="text-gold" /> <a href="tel:15195550148" className="hover:text-gold transition">+1-519-555-0148</a></li>
            <li className="flex items-center gap-2"><Mail size={14} className="text-gold" /> <a href="mailto:hello@everstoneoutdoor.ca" className="hover:text-gold transition">hello@everstoneoutdoor.ca</a></li>
