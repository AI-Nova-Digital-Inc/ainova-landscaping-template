...
export default function InterlockHero() {
  return (
    <section className="relative isolate -mt-[88px] flex min-h-[80vh] items-center justify-center overflow-hidden px-4 pb-20 pt-44 text-center text-white">
      <Image src="/images/interlock-driveways/hero/interlock-driveway-hero.jpg" alt="Luxury interlock driveway Kitchener-Waterloo" fill priority sizes="100vw" className="object-cover object-center" />
      ...
      >
        ...
        <h1 className="font-serif text-3xl font-black leading-tight tracking-tight text-warm-white drop-shadow-2xl sm:text-4xl lg:text-5xl xl:text-6xl">
          Luxury Interlock Driveway Installation<br className="hidden sm:block" /> in Kitchener-Waterloo
        </h1>
