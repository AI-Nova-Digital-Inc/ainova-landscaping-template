...
const projectTypes = [
  "New Interlock Driveway",
  "Driveway Replacement",
  "Paver Repair or Reset",
...
export default function InterlockForm() {
  ...
  return (
    <section id="estimate" className="relative overflow-hidden px-4 py-16 lg:py-24">
      <Image
        ...
        alt="Interlock driveway background"
        fill
          ...
          {sent ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  rows={4}
                  placeholder="Describe your driveway size, current surface, timeline, and any special requirements…"
