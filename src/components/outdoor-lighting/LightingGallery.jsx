...
const images = [
  { src: "/images/outdoor-lighting/gallery/gallery-01.jpg", alt: "Outdoor lighting project 1", category: "Path Lighting" },
  { src: "/images/outdoor-lighting/gallery/gallery-02.jpg", alt: "Outdoor lighting project 2", category: "Garden Lights" },
  { src: "/images/outdoor-lighting/gallery/gallery-03.jpg", alt: "Outdoor lighting project 3", category: "Accent Lighting" },
  { src: "/images/outdoor-lighting/gallery/gallery-04.jpg", alt: "Outdoor lighting project 4", category: "Patio Lighting" },
  { src: "/images/outdoor-lighting/gallery/gallery-05.jpg", alt: "Outdoor lighting project 5", category: "Path Lighting" },
  { src: "/images/outdoor-lighting/gallery/gallery-06.jpg", alt: "Outdoor lighting project 6", category: "Garden Lights" },
  { src: "/images/outdoor-lighting/gallery/gallery-07.jpg", alt: "Outdoor lighting project 7", category: "Accent Lighting" },
  { src: "/images/outdoor-lighting/gallery/gallery-08.jpg", alt: "Outdoor lighting project 8", category: "Uplighting" },
];
      ...
      <div className="mx-auto max-w-7xl">
        <FadeUp>
          <div className="mb-12 text-center">
            ...
            <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl lg:text-4xl">Outdoor Lighting Projects Across Kitchener-Waterloo</h2>
            <p className="mx-auto mt-4 max-w-xl text-warm-white/65">Architectural landscape lighting installed for residential and estate properties across the Waterloo Region.</p>
          </div>
        </FadeUp>
