    ...
    <section className="bg-evergreen-800 px-4 py-16 lg:py-24">
      <div className="mx-auto max-w-3xl text-center">
        <FadeUp>
          ...
          <h2 className="font-serif text-3xl font-black text-warm-white lg:text-4xl">Light Up Your Property Tonight</h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-warm-white/70">Architectural outdoor lighting that extends your living space and transforms your home after dark.</p>
