...
const images = [
  { src: "/images/lawn-maintenance/gallery/gallery-01.jpg", alt: "Lawn maintenance project 1", category: "Lawn Mowing" },
  { src: "/images/lawn-maintenance/gallery/gallery-02.jpg", alt: "Lawn maintenance project 2", category: "Lawn Edging" },
  { src: "/images/lawn-maintenance/gallery/gallery-03.jpg", alt: "Lawn maintenance project 3", category: "Full Cleanup" },
  { src: "/images/lawn-maintenance/gallery/gallery-04.jpg", alt: "Lawn maintenance project 4", category: "Lawn Mowing" },
  { src: "/images/lawn-maintenance/gallery/gallery-05.jpg", alt: "Lawn maintenance project 5", category: "Seasonal Care" },
  { src: "/images/lawn-maintenance/gallery/gallery-06.jpg", alt: "Lawn maintenance project 6", category: "Lawn Edging" },
  { src: "/images/lawn-maintenance/gallery/gallery-07.jpg", alt: "Lawn maintenance project 7", category: "Full Cleanup" },
  { src: "/images/lawn-maintenance/gallery/gallery-08.jpg", alt: "Lawn maintenance project 8", category: "Lawn Mowing" },
];

export default function LawnGallery() {
      ...
      <div className="mx-auto max-w-7xl">
        <FadeUp>
          <div className="mb-12 text-center">
            ...
            <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl lg:text-4xl">Lawns We Maintain Across Kitchener-Waterloo</h2>
            <p className="mx-auto mt-4 max-w-xl text-warm-white/65">Consistent, professional results for residential properties across the Waterloo Region.</p>
          </div>
        </FadeUp>
