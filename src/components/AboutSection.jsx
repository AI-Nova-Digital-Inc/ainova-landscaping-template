        ...
        <FadeUp>
          <div className="relative h-[480px] lg:h-[560px]">
            ...
            <div className="absolute inset-0 overflow-hidden rounded-2xl border-2 border-gold/30 shadow-luxury">
              <Image src="/images/retaining-walls/gallery/retaining-gallery-01.jpg" alt="Premium retaining wall landscaping" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            </div>
            ...
            <div className="absolute -bottom-6 -right-4 h-48 w-56 overflow-hidden rounded-2xl border-2 border-gold/40 shadow-luxury lg:-right-8 lg:h-56 lg:w-64">
              <Image src="/images/interlock-patios/gallery/gallery-01.jpg" alt="Interlock patio landscaping" fill sizes="280px" className="object-cover" />
            </div>
            {/* Top-left badge */}
