      ...
      <FadeUp>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a href={`tel:${site.phone}`} className="flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-10 py-4 font-bold text-white backdrop-blur-sm transition hover:bg-white/18">
