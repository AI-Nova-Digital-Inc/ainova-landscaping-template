...
const trustPoints = ["Fully Insured", "Engineered to Last", "Free On-Site Consultations"];

export default function RetainingCTA() {
  return (
      ...
      <FadeUp>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="font-serif text-3xl font-black leading-tight text-warm-white sm:text-4xl lg:text-5xl">
            Ready to Build Your Custom Retaining Wall?
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-warm-white/78">
            Secure your sloped yard, improve drainage, and elevate your curb appeal with a professionally built retaining wall designed for Ontario homes.
          </p>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a href="#estimate" className="rounded-full bg-white px-10 py-4 font-bold text-evergreen-800 shadow-luxury transition hover:-translate-y-0.5 hover:bg-warm-white">
              Book Now
            </a>
            <a href="tel:15195550148" className="flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-10 py-4 font-bold text-white backdrop-blur-sm transition hover:bg-white/18">
