...
const projectTypes = [
  "Armor Stone Wall",
  "Interlock Block Wall",
  "Natural Stone Garden Wall",
  "Tiered Retaining System",
  "Steps & Landings",
  "Erosion Control",
  "Other",
];

export default function RetainingForm() {
          ...
          {sent ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  rows={4}
                  placeholder="Describe your slope, wall height, existing drainage issues, timeline…"
