...
const images = [
  { src: "/images/interlock-patios/gallery/gallery-01.jpg", alt: "Interlock patio project 1", category: "Patio Install" },
  { src: "/images/interlock-patios/gallery/gallery-02.jpg", alt: "Interlock patio project 2", category: "Outdoor Living" },
  { src: "/images/interlock-patios/gallery/gallery-03.jpg", alt: "Interlock patio project 3", category: "Custom Design" },
  { src: "/images/interlock-patios/gallery/gallery-04.jpg", alt: "Interlock patio project 4", category: "Paver Patio" },
  { src: "/images/interlock-patios/gallery/gallery-05.jpg", alt: "Interlock patio project 5", category: "Seating Wall" },
  { src: "/images/interlock-patios/gallery/gallery-06.jpg", alt: "Interlock patio project 6", category: "Accent Border" },
  { src: "/images/interlock-patios/gallery/gallery-07.jpg", alt: "Interlock patio project 7", category: "Patio Install" },
  { src: "/images/interlock-patios/gallery/gallery-08.jpg", alt: "Interlock patio project 8", category: "Outdoor Living" },
];
      ...
      <div className="mx-auto max-w-7xl">
        <FadeUp>
          <div className="mb-12 text-center">
            ...
            <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl lg:text-4xl">Recent Interlock Patio Projects</h2>
            <p className="mx-auto mt-4 max-w-xl text-warm-white/65">Premium paver patios installed across Kitchener, Waterloo, Cambridge, and surrounding communities.</p>
          </div>
        </FadeUp>
