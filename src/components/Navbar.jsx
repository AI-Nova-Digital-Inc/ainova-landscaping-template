...
const links = [
  ...
  { label: "About", href: "/about" },
  {
    ...
    dropdown: [
      ...
      { label: "Interlock Patios", href: "/services/interlock-patios" },
      { label: "Interlock Walkways", href: "/services/interlock-walkways" },
      { label: "Lawn Maintenance", href: "/services/lawn-maintenance" },
      { label: "Outdoor Lighting", href: "/services/outdoor-lighting" },
      { label: "Outdoor Staircases", href: "/services/outdoor-staircases" },
    ],
  },
