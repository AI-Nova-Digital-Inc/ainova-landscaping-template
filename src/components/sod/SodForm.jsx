...
export default function SodForm() {
  ...
  return (
    <section id="estimate" className="relative overflow-hidden px-4 py-16 lg:py-24">
      <Image src="/images/sod/sod-form-background.png" alt="Lush lawn background" fill className="object-cover object-center" />
      <div className="absolute inset-0 bg-gradient-to-br from-evergreen-950/88 via-evergreen-950/80 to-charcoal/90" />
      <div className="relative z-10 mx-auto max-w-2xl">
        <div className="rounded-3xl border border-white/12 bg-white/10 p-8 shadow-luxury backdrop-blur-md sm:p-10">
          ...
          <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl">Request A Free Sod Installation Quote</h2>
          <p className="mt-3 text-sm leading-6 text-warm-white/70">We respond within 24 hours. No obligation.</p>
          {sent ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                { label: "Name *", type: "text", placeholder: "Your full name", required: true, col: 1 },
                { label: "Email *", type: "email", placeholder: "your@email.com", required: true, col: 1 },
                { label: "Phone", type: "tel", placeholder: "+1 (519) 000-0000", required: false, col: 1 },
                { label: "Address", type: "text", placeholder: "Property address", required: false, col: 1 },
              ...
              <div className="sm:col-span-2">
                <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-warm-white/70">Project Details</label>
                <textarea rows={4} placeholder="Describe your lawn area, any slope concerns, timeline…" className="w-full resize-none rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-sm text-warm-white placeholder-warm-white/40 backdrop-blur-sm transition focus:border-gold/50 focus:outline-none focus:ring-1 focus:ring-gold/30" />
              </div>
              <div className="sm:col-span-2">
