...
const projectTypes = ["New Front Walkway","Side Walkway","Garden Path","Walkway + Steps Combo","Driveway to Door Walkway","Walkway Repair or Reset","Other"];
export default function WalkwayForm() {
  const [sent, setSent] = useState(false);
  return (
    <section id="estimate" className="relative overflow-hidden px-4 py-16 lg:py-24">
      <Image src="/images/interlock-walkways/hero/hero-bg.jpg" alt="Walkway background" fill className="object-cover object-center" />
      ...
      <div className="relative z-10 mx-auto max-w-2xl">
        <div className="rounded-3xl border border-white/12 bg-white/10 p-8 shadow-luxury backdrop-blur-md sm:p-10">
          ...
          <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl">Get A Walkway Quote</h2>
          ...
          {sent ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea rows={4} placeholder="Describe your walkway length, style, existing surface, and timeline…" className="w-full resize-none rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-sm text-warm-white placeholder-warm-white/40 backdrop-blur-sm transition focus:border-gold/50 focus:outline-none focus:ring-1 focus:ring-gold/30" />
              </div>
              <div className="sm:col-span-2">
