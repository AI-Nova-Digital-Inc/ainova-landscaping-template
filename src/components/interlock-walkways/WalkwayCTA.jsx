...
export default function WalkwayCTA() {
  return (
    <section className="bg-evergreen-800 px-4 py-16 lg:py-24">
      <div className="mx-auto max-w-3xl text-center">
        <FadeUp>
          ...
          <h2 className="font-serif text-3xl font-black text-warm-white lg:text-4xl">Upgrade Your Walkway Today</h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-warm-white/70">Premium paver walkways and garden paths built for curb appeal, safety, and decades of performance.</p>
