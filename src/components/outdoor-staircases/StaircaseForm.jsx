...
const projectTypes = ["Natural Armor Stone Steps","Interlock Paver Steps","Concrete Cap Steps","Steps + Landing Combo","Steps + Retaining Wall","Staircase Repair","Other"];
export default function StaircaseForm() {
  const [sent, setSent] = useState(false);
  return (
    <section id="estimate" className="relative overflow-hidden px-4 py-16 lg:py-24">
      <Image src="/images/outdoor-staircases/hero/hero-bg.jpg" alt="Staircase background" fill className="object-cover object-center" />
      ...
      <div className="relative z-10 mx-auto max-w-2xl">
        <div className="rounded-3xl border border-white/12 bg-white/10 p-8 shadow-luxury backdrop-blur-md sm:p-10">
          ...
          <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl">Get A Staircase Quote</h2>
          ...
          {sent ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="mt-8 grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea rows={4} placeholder="Describe your slope, number of steps needed, material preference, and timeline…" className="w-full resize-none rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-sm text-warm-white placeholder-warm-white/40 backdrop-blur-sm transition focus:border-gold/50 focus:outline-none focus:ring-1 focus:ring-gold/30" />
              </div>
              <div className="sm:col-span-2">
