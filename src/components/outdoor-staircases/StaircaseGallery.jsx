...
const images = [
  { src: "/images/outdoor-staircases/gallery/gallery-01.jpg", alt: "Outdoor staircase project 1", category: "Stone Steps" },
  { src: "/images/outdoor-staircases/gallery/gallery-02.jpg", alt: "Outdoor staircase project 2", category: "Interlock Steps" },
  { src: "/images/outdoor-staircases/gallery/gallery-03.jpg", alt: "Outdoor staircase project 3", category: "Natural Stone" },
  { src: "/images/outdoor-staircases/gallery/gallery-04.jpg", alt: "Outdoor staircase project 4", category: "Grade Transition" },
  { src: "/images/outdoor-staircases/gallery/gallery-05.jpg", alt: "Outdoor staircase project 5", category: "Stone Steps" },
  { src: "/images/outdoor-staircases/gallery/gallery-06.jpg", alt: "Outdoor staircase project 6", category: "Landing & Steps" },
  { src: "/images/outdoor-staircases/gallery/gallery-07.jpg", alt: "Outdoor staircase project 7", category: "Interlock Steps" },
  { src: "/images/outdoor-staircases/gallery/gallery-08.jpg", alt: "Outdoor staircase project 8", category: "Natural Stone" },
];

export default function StaircaseGallery() {
      ...
      <div className="mx-auto max-w-7xl">
        <FadeUp>
          <div className="mb-12 text-center">
            ...
            <h2 className="font-serif text-2xl font-black text-warm-white sm:text-3xl lg:text-4xl">Recent Outdoor Staircase Projects</h2>
            <p className="mx-auto mt-4 max-w-xl text-warm-white/65">Stone steps and grade transitions installed across Kitchener-Waterloo Region.</p>
          </div>
        </FadeUp>
