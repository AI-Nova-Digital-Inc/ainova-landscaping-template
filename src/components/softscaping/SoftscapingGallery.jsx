...
const categories = [
  "Garden Bed", "Privacy Planting", "Mulch Install", "River Rock", "Garden Bed",
  "Shrub Planting", "Garden Bed", "River Rock", "Mulch Install", "Privacy Planting",
  "Garden Bed", "Full Softscape",
];

const images = Array.from({ length: 12 }, (_, i) => ({
  src: `/images/softscaping/gallery/softscaping-gallery-${String(i + 1).padStart(2, "0")}.jpg`,
  alt: `Softscaping project ${i + 1} Kitchener-Waterloo`,
  category: categories[i],
}));

export default function SoftscapingGallery() {
        ...
        <FadeUp>
          <div className="mb-12 text-center">
            ...
            <h2 className="font-serif text-2xl font-black text-charcoal sm:text-3xl lg:text-4xl">
              View Our Recent Softscaping &amp; Garden Transformations
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-charcoal/65 leading-7">
              Explore garden beds, privacy plantings, mulch installs, river rock features, and finished landscapes designed across Kitchener, Waterloo, and Cambridge.
            </p>
          </div>
        </FadeUp>
